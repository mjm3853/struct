...
Three evaluators:
  ...
  3. response_quality — does the final answer mention expected terms?
...
EVALUATORS = [tool_selection, argument_accuracy, response_quality]
...
async def run_langsmith(prefix: str):
    ...
    async for result in results:
        ...
        all_pass = all(s == 1.0 for s in scores.values())
        if all_pass:
            passed += 1
